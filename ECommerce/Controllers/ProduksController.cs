...
namespace eCommerce.Controllers
{
    public class ProduksController : Controller
    {
        ...
        public ProduksController(eCommerceDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProduk,NamaProduk,DeskripsiProduk,HargaProduk,Stok,Gambar")] Produk produk)
        {

...
namespace eCommerce.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCustomer,Nama,NoHp,Username,Password,FotoProfile,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCustomer,Nama,NoHp,Username,Password,FotoProfile,Email")] Customer customer)
        {
